export const SAINT_LEVELS = [
  { level: 1, name: 'Wanderer', minProgress: 0, env: 'Dusty Path', avatar: '/avatars/wanderer.png', environment: '/environments/dusty-path.png' },
  { level: 2, name: 'Disciplined Seeker', minProgress: 15, env: 'Forest', avatar: '/avatars/seeker.png', environment: '/environments/forest.png' },
  { level: 3, name: 'Yogi', minProgress: 30, env: 'Hermitage', avatar: '/avatars/yogi.png', environment: '/environments/hermitage.png' },
  { level: 4, name: 'Sage', minProgress: 50, env: 'Ashram', avatar: '/avatars/sage.png', environment: '/environments/ashram.png' },
  { level: 5, name: 'Master', minProgress: 70, env: 'Temple', avatar: '/avatars/master.png', environment: '/environments/temple.png' },
  { level: 6, name: 'Enlightened One', minProgress: 85, env: 'Celestial Realm', avatar: '/avatars/enlightened.png', environment: '/environments/celestial.png' },
  { level: 7, name: 'Liberation', minProgress: 95, env: 'Liberation Realm', avatar: '/avatars/liberation.png', environment: '/environments/liberation-realm.png' }
];
